...
numHiddenLayers = 8
actList = ['elu', 'elu', 'relu', 'relu', 'relu', 'relu', 'relu', 'relu']
dropList = [0.5, 0.2, 0.1, 0.2, 0, 0.1, 0.3, 0.2]
batchNorm = [0, 1, 1, 0, 0, 1, 0, 1]
batchSize = 32768
hiddenLayer = [1982, 2438, 3187, 1478, 1827, 1983, 1466, 1679]
