...
date
/usr/bin/time singularity exec --nv /xdisk/rlysecky/manojgopale/extra/fromBethard/AES_data/dockerImage/ocelote_keras-2.2.4+tensorflow-1.13.1_gpu-cp35-cuda10.0-cudnn7.5.sif python3.5 /xdisk/rlysecky/manojgopale/extra/gem5KeyPrediction/scr/run_general_template_dataEnsemble.py --modelName ${modelName}  --testFlag 1 --trainSize ${trainSize} --numPowerTraces ${numPowerTraces} --numConfig ${numConfig} --typeOfStd ${typeOfStd} --configList config4p1 --configIndex ${configIndex}
date
