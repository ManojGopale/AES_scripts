...
modelConfig    = options.modelConfig ##config whose model we are loading
...
x_test, y_test = data.getData(testDir, testDataConfig, testSize, "Dev")
...
## Models from the run's for config5p3_15000TrainSize config
modelList = [\
"rerun_dataEns49_43_config_tr7500_3p1_3HL_6epochs_100p00_acc_.h5",\
"rerun_dataEns49_43_config_tr7500_3p2_3HL_7epochs_100p00_acc_.h5",\
"rerun_dataEns49_43_config_tr7500_3p3_3HL_6epochs_100p00_acc_.h5",\
"rerun_dataEns49_43_config_tr7500_3p4_3HL_9epochs_100p00_acc_.h5",\
"rerun_dataEns49_43_config_tr7500_4p1_3HL_6epochs_100p00_acc_.h5",\
"rerun_dataEns49_43_config_tr7500_4p2_3HL_6epochs_99p99_acc_.h5",\
"rerun_dataEns49_43_config_tr7500_4p3_3HL_8epochs_100p00_acc_.h5",\
"rerun_dataEns49_43_config_tr7500_4p4_3HL_6epochs_100p00_acc_.h5",\
"rerun_dataEns49_43_config_tr7500_5p1_3HL_7epochs_100p00_acc_.h5",\
"rerun_dataEns49_43_config_tr7500_5p2_3HL_6epochs_100p00_acc_.h5",\
"rerun_dataEns49_43_config_tr7500_5p3_3HL_6epochs_100p00_acc_.h5",\
"rerun_dataEns49_43_config_tr7500_5p4_3HL_6epochs_100p00_acc_.h5"\
]
...
for modelName in modelList:
	...
	if (os.path.isfile(modelPath)):
		...
		outputFile = modelDir + "/" + testDataConfig + "/"  + "testDataOf_" + testDataConfig + "_modelOf_" + "_".join(modelName.split("_")[1:2]) + "_test.csv" 
		...
		## Save to tsv
		saveFile = modelDir + "/" + testDataConfig + "/"  + "testDataOf_" + testDataConfig + "_modelOf_" + "_".join(modelName.split("_")[1:2]) + "_test_keyAccuracy.tsv" 
		...
		logFile = modelDir + '/../log/' + testDataConfig + '/testDataOf_' + testDataConfig + '_modelOf_'+ "_".join(modelName.split("_")[1:2]) + "_" + '{0:.2f}'.format(model_score[1]*100).replace('.', 'p') + '_acc_' + "keyAccuracy.log" 
