...
import classify_general_oldDevData
...
_, devData, _ = classify_general_oldDevData.getData(devDataDir, devDataConfig, trainSize, trainFlag, devFlag, testFlag)
...
for modelConfig, modelName in modelDict.items():
	...
	outputFile = modelDir + "/" + devDataConfig + "/"  + "OldDevData_dataOf_" + devDataConfig + "_modelOf_" + configList[count] + "_dev.csv" 
	...
	## Save to tsv
	saveFile = modelDir + "/" + devDataConfig + "/"  + "OldDevData_dataOf_" + devDataConfig + "_modelOf_" + configList[count] + "_dev_keyAccuracy.tsv" 
	...
	logFile = modelDir + '/../log/' + devDataConfig + '/OldDevData_dataOf_' + devDataConfig + '_modelOf_'+ configList[count] + "_" + '{0:.2f}'.format(model_score[1]*100).replace('.', 'p') + '_acc_' + "keyAccuracy.log" 
