...
### Set the job name 
#PBS -N moreData_chipWhisperer_keyPrediction

## Request email when job begins and ends
#PBS -m bea

########## Error and Output Path
#PBS -e /home/u3/manojgopale/AES_error_output_dir/moreData_chipWhisperer_keyPrediction_error.txt
#PBS -o /home/u3/manojgopale/AES_error_output_dir/moreData_chipWhisperer_keyPrediction_output.txt
...
date
/usr/bin/time singularity exec --nv /xdisk/rlysecky/manojgopale/extra/fromBethard/AES_data/dockerImage/ocelote_keras-2.2.4+tensorflow-1.13.1_gpu-cp35-cuda10.0-cudnn7.5.sif python3.5 /xdisk/rlysecky/manojgopale/extra/keyPrediction_chip/scr/moreDataTrials/scr/keyPrediction.py
date
