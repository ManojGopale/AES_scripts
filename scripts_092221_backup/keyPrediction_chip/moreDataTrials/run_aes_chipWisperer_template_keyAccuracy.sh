...
### Set the job name 
#PBS -N moreData_chipWhisperer_keyAccuracy

## Request email when job begins and ends
#PBS -m bea

########## Error and Output Path
#PBS -e /home/u3/manojgopale/AES_error_output_dir/moreData_chipWhisperer_keyAccuracy_error.txt
#PBS -o /home/u3/manojgopale/AES_error_output_dir/moreData_chipWhisperer_keyAccuracy_output.txt
