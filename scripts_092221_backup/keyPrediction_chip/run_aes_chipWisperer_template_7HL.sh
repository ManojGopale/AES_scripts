...
### Set the job name 
#PBS -N chipWhisperer_bs_2048_3HL_2000_1000_1500_0p2_0p2_0p2_0p2_50patience_noPre

## Request email when job begins and ends
#PBS -m bea

########## Error and Output Path
#PBS -e /home/u3/manojgopale/AES_error_output_dir/chipWhisperer_bs_2048_3HL_2000_1000_1500_0p2_0p2_0p2_0p2_50patience_noPre_error.txt
#PBS -o /home/u3/manojgopale/AES_error_output_dir/chipWhisperer_bs_2048_3HL_2000_1000_1500_0p2_0p2_0p2_0p2_50patience_noPre_output.txt
...
date
/usr/bin/time singularity exec --nv /xdisk/bethard/mig2020/extra/manojgopale/AES_data/dockerImage/ocelote_keras-2.2.4+tensorflow-1.13.1_gpu-cp35-cuda10.0-cudnn7.5.sif python3.5 /xdisk/rlysecky/manojgopale/extra/keyPrediction_chip/scr/run_7hl_template.py --batchSize 2048 --modelName chipWhisper_7HL_noPre  --testFlag 1 --drop1 0.2 --drop2 0.2 --drop3 0.2 --drop4 0.2 --drop5 0.2 --drop6 0.2 --drop7 0.2 --trainSize 15000
