...
date
/usr/bin/time singularity exec --nv /xdisk/bethard/mig2020/extra/manojgopale/AES_data/dockerImage/ocelote_keras-2.2.4+tensorflow-1.13.1_gpu-cp35-cuda10.0-cudnn7.5.sif python3.5 /xdisk/rlysecky/manojgopale/extra/keyPrediction_chip/scr/run_4hl_template.py --batchSize 2048 --modelName chipWhisper_bs_2048_3HL_2000_1000_1500_0p2_0p2_0p2_0p2_1000epochs_50patience  --testFlag 1 --drop1 0.2 --drop2 0.2 --drop3 0.2 --drop4 0.2
