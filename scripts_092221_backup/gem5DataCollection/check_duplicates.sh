...
### Set the job name 
#PBS -N check_duplicates

## Request email when job begins and ends
#PBS -m bea

###### Error and Output Path
#PBS -e /xdisk/rlysecky/manojgopale/extra/gem5DataCollection/log/check_duplicates_csvof_config4p2_keys_224_256_040921_error.txt
#PBS -o /xdisk/rlysecky/manojgopale/extra/gem5DataCollection/log/check_duplicates_csvof_config4p2_keys_224_256_040921_output.txt
