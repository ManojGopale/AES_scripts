...
matlab -r 'qResult_folders = ["default_cache_0",  "default_cache_1", "default_cache_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config3p1/";generateTrace(qResult_folders, outputPath);exit;'
