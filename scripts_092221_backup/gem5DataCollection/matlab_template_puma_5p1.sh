...
matlab -r 'qResult_folders = ["dram_l2default_0",  "dram_l2default_1", "dram_l2default_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config5p1/";generateTrace(qResult_folders, outputPath);exit;'
