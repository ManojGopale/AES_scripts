...
matlab -r 'qResult_folders = ["l2_l1associate8_0",  "l2_l1associate8_1", "l2_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config4p2/";generateTrace(qResult_folders, outputPath, 193, 195);exit;'

##Mexport manoj_192=${192}
##Mexport manoj_195=${195}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;192=str2double(getenv('manoj_192'));195=str2double(getenv('manoj_195'));configName=string(getenv('configName'));fprintf('192=%d 195= %d, configName=%s',192, 195, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=192:195; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
