...
matlab -r 'qResult_folders = ["dram_l24m_default_0",  "dram_l24m_default_1", "dram_l24m_default_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config5p3/";generateTrace(qResult_folders, outputPath, 196, 210);exit;'
