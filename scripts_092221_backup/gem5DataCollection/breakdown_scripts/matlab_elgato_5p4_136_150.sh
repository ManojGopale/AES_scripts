...
matlab -r 'qResult_folders = ["dram_l24m_l1associate8_0",  "dram_l24m_l1associate8_1", "dram_l24m_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config5p4/";generateTrace(qResult_folders, outputPath, 136, 150);exit;'

##Mexport manoj_136=${136}
##Mexport manoj_150=${150}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;136=str2double(getenv('manoj_136'));150=str2double(getenv('manoj_150'));configName=string(getenv('configName'));fprintf('136=%d 150= %d, configName=%s',136, 150, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=136:150; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
