...
matlab -r 'qResult_folders = ["l2_l1associate8_0",  "l2_l1associate8_1", "l2_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config4p2/";generateTrace(qResult_folders, outputPath, 148, 150);exit;'

##Mexport manoj_147=${147}
##Mexport manoj_150=${150}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;147=str2double(getenv('manoj_147'));150=str2double(getenv('manoj_150'));configName=string(getenv('configName'));fprintf('147=%d 150= %d, configName=%s',147, 150, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=147:150; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
