...
matlab -r 'qResult_folders = ["dram_l2_l1associate8_0",  "dram_l2_l1associate8_1", "dram_l2_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config5p2/";generateTrace(qResult_folders, outputPath, 31, 45);exit;'
