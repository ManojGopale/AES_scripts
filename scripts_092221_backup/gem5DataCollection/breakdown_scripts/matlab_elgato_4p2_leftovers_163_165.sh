...
matlab -r 'qResult_folders = ["l2_l1associate8_0",  "l2_l1associate8_1", "l2_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config4p2/";generateTrace(qResult_folders, outputPath, 163, 165);exit;'

##Mexport manoj_162=${162}
##Mexport manoj_165=${165}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;162=str2double(getenv('manoj_162'));165=str2double(getenv('manoj_165'));configName=string(getenv('configName'));fprintf('162=%d 165= %d, configName=%s',162, 165, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=162:165; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
