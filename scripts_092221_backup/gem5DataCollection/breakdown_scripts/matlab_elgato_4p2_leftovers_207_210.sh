...
matlab -r 'qResult_folders = ["l2_l1associate8_0",  "l2_l1associate8_1", "l2_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config4p2/";generateTrace(qResult_folders, outputPath, 207, 210);exit;'

##Mexport manoj_207=${207}
##Mexport manoj_210=${210}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;207=str2double(getenv('manoj_207'));210=str2double(getenv('manoj_210'));configName=string(getenv('configName'));fprintf('207=%d 210= %d, configName=%s',207, 210, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=207:210; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
