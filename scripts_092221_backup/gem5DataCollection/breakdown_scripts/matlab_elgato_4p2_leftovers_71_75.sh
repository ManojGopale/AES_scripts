...
matlab -r 'qResult_folders = ["l2_l1associate8_0",  "l2_l1associate8_1", "l2_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config4p2/";generateTrace(qResult_folders, outputPath, 71, 75);exit;'

##Mexport manoj_72=${72}
##Mexport manoj_75=${75}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;72=str2double(getenv('manoj_72'));75=str2double(getenv('manoj_75'));configName=string(getenv('configName'));fprintf('72=%d 75= %d, configName=%s',72, 75, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=72:75; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
