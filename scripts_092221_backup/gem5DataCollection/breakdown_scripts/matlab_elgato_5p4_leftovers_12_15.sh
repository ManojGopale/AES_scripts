...
matlab -r 'qResult_folders = ["dram_l24m_l1associate8_0",  "dram_l24m_l1associate8_1", "dram_l24m_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config5p4/";generateTrace(qResult_folders, outputPath, 12, 15);exit;'

##Mexport manoj_12=${12}
##Mexport manoj_15=${15}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;12=str2double(getenv('manoj_12'));15=str2double(getenv('manoj_15'));configName=string(getenv('configName'));fprintf('12=%d 15= %d, configName=%s',12, 15, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=12:15; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
