...
matlab -r 'qResult_folders = ["dram_l24m_l1associate8_0",  "dram_l24m_l1associate8_1", "dram_l24m_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config5p4/";generateTrace(qResult_folders, outputPath, 106, 120);exit;'

##Mexport manoj_106=${106}
##Mexport manoj_120=${120}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;106=str2double(getenv('manoj_106'));120=str2double(getenv('manoj_120'));configName=string(getenv('configName'));fprintf('106=%d 120= %d, configName=%s',106, 120, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=106:120; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
