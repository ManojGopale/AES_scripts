...
matlab -r 'qResult_folders = ["l2_l1associate8_0",  "l2_l1associate8_1", "l2_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config4p2/";generateTrace(qResult_folders, outputPath, 57, 60);exit;'

##Mexport manoj_57=${57}
##Mexport manoj_60=${60}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;57=str2double(getenv('manoj_57'));60=str2double(getenv('manoj_60'));configName=string(getenv('configName'));fprintf('57=%d 60= %d, configName=%s',57, 60, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=57:60; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
