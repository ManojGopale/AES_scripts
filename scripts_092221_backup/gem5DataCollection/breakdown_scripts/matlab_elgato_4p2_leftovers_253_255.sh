...
matlab -r 'qResult_folders = ["l2_l1associate8_0",  "l2_l1associate8_1", "l2_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config4p2/";generateTrace(qResult_folders, outputPath, 253, 255);exit;'

##Mexport manoj_252=${252}
##Mexport manoj_255=${255}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;252=str2double(getenv('manoj_252'));255=str2double(getenv('manoj_255'));configName=string(getenv('configName'));fprintf('252=%d 255= %d, configName=%s',252, 255, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=252:255; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
