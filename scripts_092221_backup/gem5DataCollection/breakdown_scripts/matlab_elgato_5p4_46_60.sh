...
matlab -r 'qResult_folders = ["dram_l24m_l1associate8_0",  "dram_l24m_l1associate8_1", "dram_l24m_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config5p4/";generateTrace(qResult_folders, outputPath, 46, 60);exit;'

##Mexport manoj_46=${46}
##Mexport manoj_60=${60}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;46=str2double(getenv('manoj_46'));60=str2double(getenv('manoj_60'));configName=string(getenv('configName'));fprintf('46=%d 60= %d, configName=%s',46, 60, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=46:60; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
