...
matlab -r 'qResult_folders = ["dram_l24m_l1associate8_0",  "dram_l24m_l1associate8_1", "dram_l24m_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config5p4/";generateTrace(qResult_folders, outputPath, 58, 60);exit;'

##Mexport manoj_58=${58}
##Mexport manoj_60=${60}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;58=str2double(getenv('manoj_58'));60=str2double(getenv('manoj_60'));configName=string(getenv('configName'));fprintf('58=%d 60= %d, configName=%s',58, 60, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=58:60; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
