...
matlab -r 'qResult_folders = ["dram_l24m_l1associate8_0",  "dram_l24m_l1associate8_1", "dram_l24m_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config5p4/";generateTrace(qResult_folders, outputPath, 16, 30);exit;'

##Mexport manoj_16=${16}
##Mexport manoj_30=${30}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;16=str2double(getenv('manoj_16'));30=str2double(getenv('manoj_30'));configName=string(getenv('configName'));fprintf('16=%d 30= %d, configName=%s',16, 30, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=16:30; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
