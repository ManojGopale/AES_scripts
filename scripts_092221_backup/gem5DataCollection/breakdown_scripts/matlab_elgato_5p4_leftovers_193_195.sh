...
matlab -r 'qResult_folders = ["dram_l24m_l1associate8_0",  "dram_l24m_l1associate8_1", "dram_l24m_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config5p4/";generateTrace(qResult_folders, outputPath, 193, 195);exit;'

##Mexport manoj_193=${193}
##Mexport manoj_195=${195}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;193=str2double(getenv('manoj_193'));195=str2double(getenv('manoj_195'));configName=string(getenv('configName'));fprintf('193=%d 195= %d, configName=%s',193, 195, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=193:195; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
