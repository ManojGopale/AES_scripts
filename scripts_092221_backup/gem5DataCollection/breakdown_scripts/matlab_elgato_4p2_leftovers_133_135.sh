...
matlab -r 'qResult_folders = ["l2_l1associate8_0",  "l2_l1associate8_1", "l2_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config4p2/";generateTrace(qResult_folders, outputPath, 133, 135);exit;'

##Mexport manoj_132=${132}
##Mexport manoj_135=${135}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;132=str2double(getenv('manoj_132'));135=str2double(getenv('manoj_135'));configName=string(getenv('configName'));fprintf('132=%d 135= %d, configName=%s',132, 135, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=132:135; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
