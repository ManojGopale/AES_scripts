...
matlab -r 'qResult_folders = ["l2default_0",  "l2default_1", "l2default_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config4p1/";generateTrace(qResult_folders, outputPath, 181, 195);exit;'
