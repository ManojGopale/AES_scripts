...
matlab -r 'qResult_folders = ["64kcache_0",  "64kcache_1", "64kcache_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config3p3/";generateTrace(qResult_folders, outputPath, 226, 240);exit;'
