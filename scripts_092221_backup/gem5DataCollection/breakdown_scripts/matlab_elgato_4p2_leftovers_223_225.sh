...
matlab -r 'qResult_folders = ["l2_l1associate8_0",  "l2_l1associate8_1", "l2_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config4p2/";generateTrace(qResult_folders, outputPath, 223, 225);exit;'

##Mexport manoj_222=${222}
##Mexport manoj_225=${225}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;222=str2double(getenv('manoj_222'));225=str2double(getenv('manoj_225'));configName=string(getenv('configName'));fprintf('222=%d 225= %d, configName=%s',222, 225, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=222:225; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
