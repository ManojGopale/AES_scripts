...
matlab -r 'qResult_folders = ["dram_l24m_l1associate8_0",  "dram_l24m_l1associate8_1", "dram_l24m_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config5p4/";generateTrace(qResult_folders, outputPath, 31, 45);exit;'

##Mexport manoj_31=${31}
##Mexport manoj_45=${45}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;31=str2double(getenv('manoj_31'));45=str2double(getenv('manoj_45'));configName=string(getenv('configName'));fprintf('31=%d 45= %d, configName=%s',31, 45, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=31:45; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
