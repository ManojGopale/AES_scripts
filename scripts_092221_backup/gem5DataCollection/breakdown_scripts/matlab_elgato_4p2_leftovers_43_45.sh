...
matlab -r 'qResult_folders = ["l2_l1associate8_0",  "l2_l1associate8_1", "l2_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config4p2/";generateTrace(qResult_folders, outputPath, 43, 45);exit;'

##Mexport manoj_42=${42}
##Mexport manoj_45=${45}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;42=str2double(getenv('manoj_42'));45=str2double(getenv('manoj_45'));configName=string(getenv('configName'));fprintf('42=%d 45= %d, configName=%s',42, 45, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=42:45; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
