...
matlab -r 'qResult_folders = ["l2_l1associate8_0",  "l2_l1associate8_1", "l2_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config4p2/";generateTrace(qResult_folders, outputPath, 177, 180);exit;'

##Mexport manoj_177=${177}
##Mexport manoj_180=${180}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;177=str2double(getenv('manoj_177'));180=str2double(getenv('manoj_180'));configName=string(getenv('configName'));fprintf('177=%d 180= %d, configName=%s',177, 180, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=177:180; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
