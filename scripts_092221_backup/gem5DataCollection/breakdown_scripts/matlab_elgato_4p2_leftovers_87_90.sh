...
matlab -r 'qResult_folders = ["l2_l1associate8_0",  "l2_l1associate8_1", "l2_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config4p2/";generateTrace(qResult_folders, outputPath, 87, 90);exit;'

##Mexport manoj_87=${87}
##Mexport manoj_90=${90}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;87=str2double(getenv('manoj_87'));90=str2double(getenv('manoj_90'));configName=string(getenv('configName'));fprintf('87=%d 90= %d, configName=%s',87, 90, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=87:90; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
