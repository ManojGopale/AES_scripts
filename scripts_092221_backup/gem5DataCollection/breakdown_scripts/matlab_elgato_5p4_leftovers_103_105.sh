...
matlab -r 'qResult_folders = ["dram_l24m_l1associate8_0",  "dram_l24m_l1associate8_1", "dram_l24m_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config5p4/";generateTrace(qResult_folders, outputPath, 103, 105);exit;'

##Mexport manoj_103=${103}
##Mexport manoj_105=${105}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;103=str2double(getenv('manoj_103'));105=str2double(getenv('manoj_105'));configName=string(getenv('configName'));fprintf('103=%d 105= %d, configName=%s',103, 105, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=103:105; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
