...
matlab -r 'qResult_folders = ["dram_l24m_l1associate8_0",  "dram_l24m_l1associate8_1", "dram_l24m_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config5p4/";generateTrace(qResult_folders, outputPath, 133, 135);exit;'

##Mexport manoj_133=${133}
##Mexport manoj_135=${135}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;133=str2double(getenv('manoj_133'));135=str2double(getenv('manoj_135'));configName=string(getenv('configName'));fprintf('133=%d 135= %d, configName=%s',133, 135, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=133:135; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
