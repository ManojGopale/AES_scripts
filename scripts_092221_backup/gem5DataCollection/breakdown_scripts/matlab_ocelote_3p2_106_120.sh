...
matlab -r 'qResult_folders = ["cache_associate8_0",  "cache_associate8_1", "cache_associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config3p2/";generateTrace(qResult_folders, outputPath, 106, 120);exit;'
