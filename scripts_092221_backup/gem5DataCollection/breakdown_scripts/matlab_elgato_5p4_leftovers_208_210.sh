...
matlab -r 'qResult_folders = ["dram_l24m_l1associate8_0",  "dram_l24m_l1associate8_1", "dram_l24m_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config5p4/";generateTrace(qResult_folders, outputPath, 208, 210);exit;'

##Mexport manoj_208=${208}
##Mexport manoj_210=${210}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;208=str2double(getenv('manoj_208'));210=str2double(getenv('manoj_210'));configName=string(getenv('configName'));fprintf('208=%d 210= %d, configName=%s',208, 210, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=208:210; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
