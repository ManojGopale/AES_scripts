...
matlab -r 'qResult_folders = ["dram_l24m_l1associate8_0",  "dram_l24m_l1associate8_1", "dram_l24m_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config5p4/";generateTrace(qResult_folders, outputPath, 151, 165);exit;'

##Mexport manoj_151=${151}
##Mexport manoj_165=${165}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;151=str2double(getenv('manoj_151'));165=str2double(getenv('manoj_165'));configName=string(getenv('configName'));fprintf('151=%d 165= %d, configName=%s',151, 165, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=151:165; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
