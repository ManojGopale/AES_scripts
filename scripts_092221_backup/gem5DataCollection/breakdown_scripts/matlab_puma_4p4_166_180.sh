...
matlab -r 'qResult_folders = ["l24m_l1associate8_0",  "l24m_l1associate8_1", "l24m_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config4p4/";generateTrace(qResult_folders, outputPath, 166, 180);exit;'
