...
matlab -r 'qResult_folders = ["l24m_default_0",  "l24m_default_1", "l24m_default_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config4p3/";generateTrace(qResult_folders, outputPath, 0, 15);exit;'
