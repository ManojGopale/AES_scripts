...
matlab -r 'qResult_folders = ["l2_l1associate8_0",  "l2_l1associate8_1", "l2_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config4p2/";generateTrace(qResult_folders, outputPath, 27, 30);exit;'

##Mexport manoj_27=${27}
##Mexport manoj_30=${30}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;27=str2double(getenv('manoj_27'));30=str2double(getenv('manoj_30'));configName=string(getenv('configName'));fprintf('27=%d 30= %d, configName=%s',27, 30, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=27:30; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
