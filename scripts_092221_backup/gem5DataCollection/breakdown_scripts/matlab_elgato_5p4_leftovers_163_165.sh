...
matlab -r 'qResult_folders = ["dram_l24m_l1associate8_0",  "dram_l24m_l1associate8_1", "dram_l24m_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config5p4/";generateTrace(qResult_folders, outputPath, 163, 165);exit;'

##Mexport manoj_163=${163}
##Mexport manoj_165=${165}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;163=str2double(getenv('manoj_163'));165=str2double(getenv('manoj_165'));configName=string(getenv('configName'));fprintf('163=%d 165= %d, configName=%s',163, 165, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=163:165; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
