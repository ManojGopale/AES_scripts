...
matlab -r 'qResult_folders = ["l2_l1associate8_0",  "l2_l1associate8_1", "l2_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config4p2/";generateTrace(qResult_folders, outputPath, 117, 120);exit;'

##Mexport manoj_117=${117}
##Mexport manoj_120=${120}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;117=str2double(getenv('manoj_117'));120=str2double(getenv('manoj_120'));configName=string(getenv('configName'));fprintf('117=%d 120= %d, configName=%s',117, 120, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=117:120; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
