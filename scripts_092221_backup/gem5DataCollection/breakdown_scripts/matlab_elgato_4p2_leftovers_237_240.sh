...
matlab -r 'qResult_folders = ["l2_l1associate8_0",  "l2_l1associate8_1", "l2_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config4p2/";generateTrace(qResult_folders, outputPath, 237, 240);exit;'

##Mexport manoj_237=${237}
##Mexport manoj_240=${240}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;237=str2double(getenv('manoj_237'));240=str2double(getenv('manoj_240'));configName=string(getenv('configName'));fprintf('237=%d 240= %d, configName=%s',237, 240, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=237:240; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
