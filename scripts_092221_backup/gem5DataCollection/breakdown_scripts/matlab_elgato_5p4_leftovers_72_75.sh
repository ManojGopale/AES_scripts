...
matlab -r 'qResult_folders = ["dram_l24m_l1associate8_0",  "dram_l24m_l1associate8_1", "dram_l24m_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config5p4/";generateTrace(qResult_folders, outputPath, 72, 75);exit;'

##Mexport manoj_73=${73}
##Mexport manoj_75=${75}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;73=str2double(getenv('manoj_73'));75=str2double(getenv('manoj_75'));configName=string(getenv('configName'));fprintf('73=%d 75= %d, configName=%s',73, 75, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=73:75; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
