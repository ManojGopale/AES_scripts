...
matlab -r 'qResult_folders = ["l2_l1associate8_0",  "l2_l1associate8_1", "l2_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config4p2/";generateTrace(qResult_folders, outputPath, 11, 15);exit;'

##Mexport manoj_11=${11}
##Mexport manoj_15=${15}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;11=str2double(getenv('manoj_11'));15=str2double(getenv('manoj_15'));configName=string(getenv('configName'));fprintf('11=%d 15= %d, configName=%s',11, 15, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=11:15; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
