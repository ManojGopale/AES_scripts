...
matlab -r 'qResult_folders = ["dram_l24m_l1associate8_0",  "dram_l24m_l1associate8_1", "dram_l24m_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config5p4/";generateTrace(qResult_folders, outputPath, 88, 90);exit;'

##Mexport manoj_88=${88}
##Mexport manoj_90=${90}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;88=str2double(getenv('manoj_88'));90=str2double(getenv('manoj_90'));configName=string(getenv('configName'));fprintf('88=%d 90= %d, configName=%s',88, 90, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=88:90; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
