...
matlab -r 'qResult_folders = ["l2_l1associate8_0",  "l2_l1associate8_1", "l2_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config4p2/";generateTrace(qResult_folders, outputPath, 103, 105);exit;'

##Mexport manoj_102=${102}
##Mexport manoj_105=${105}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;102=str2double(getenv('manoj_102'));105=str2double(getenv('manoj_105'));configName=string(getenv('configName'));fprintf('102=%d 105= %d, configName=%s',102, 105, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=102:105; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
