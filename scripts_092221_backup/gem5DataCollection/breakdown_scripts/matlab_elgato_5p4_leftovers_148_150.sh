...
matlab -r 'qResult_folders = ["dram_l24m_l1associate8_0",  "dram_l24m_l1associate8_1", "dram_l24m_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config5p4/";generateTrace(qResult_folders, outputPath, 148, 150);exit;'

##Mexport manoj_148=${148}
##Mexport manoj_150=${150}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;148=str2double(getenv('manoj_148'));150=str2double(getenv('manoj_150'));configName=string(getenv('configName'));fprintf('148=%d 150= %d, configName=%s',148, 150, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=148:150; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
