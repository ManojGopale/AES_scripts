...
matlab -r 'qResult_folders = ["dram_l24m_l1associate8_0",  "dram_l24m_l1associate8_1", "dram_l24m_l1associate8_2"];outputPath = "/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/config5p4/";generateTrace(qResult_folders, outputPath, 253, 255);exit;'

##Mexport manoj_253=${253}
##Mexport manoj_255=${255}
##Mexport manoj_configName=${configName}
##Mmatlab -r "try;253=str2double(getenv('manoj_253'));255=str2double(getenv('manoj_255'));configName=string(getenv('configName'));fprintf('253=%d 255= %d, configName=%s',253, 255, configName);qResult_folders = [string('l24m_l1associate8_0'), 'l24m_l1associate8_1', 'l24m_l1associate8_2'];outputPath = '/xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/matResult/' + configName';fprintf('\noutputPath=%s\n', outputPath);parfor key=253:255; generateTrace(qResult_folders, outputPath, key, key);end;catch;end;exit;"
date
