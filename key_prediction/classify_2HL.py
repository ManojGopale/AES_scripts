...
class Classifier:
	def __init__(self, resultDir: str, modelName: str, x_train, y_train_oh, x_dev, y_dev_oh, x_test, y_test_oh, hidden1Size, hidden2Size):
		...
		self.model.add(Dense(self.hidden1Size, input_shape=(1361,)))
		self.model.add(Activation('relu'))                            
		self.model.add(Dropout(self.dropOut))

		self.model.add(Dense(self.hidden2Size))
		self.model.add(Activation('relu'))                            
		self.model.add(Dropout(self.dropOut))
