...
trainData, devData, testData = classify_3HL_28000TrainSize.getData(dataDir, moreDataDir, trainSize, trainFlag, devFlag, testFlag)
...
t0_time = time.time()
classifier = classify_3HL_28000TrainSize.Classifier(resultDir, modelName, x_train, y_train_oh, x_dev, y_dev_oh, x_test, y_test_oh, drop1, drop2, drop3)
t1_time = time.time()
