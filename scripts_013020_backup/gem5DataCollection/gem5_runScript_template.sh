...
date
/usr/bin/time singularity exec -B /xdisk/rlysecky/manojgopale/xdisk/ /xdisk/rlysecky/manojgopale/extra/gem5DataCollection/dockerImage/gem5_approx_3399input_newDirstruct.sif  /bin/bash /xdisk/rlysecky/manojgopale/xdisk/gem5DataCollection/runDir/${configName}_${iteration}/fullScriptDir/full.sh
date
